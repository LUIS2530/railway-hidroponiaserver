      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            _context2.next = 5;
            return connection.query("SELECT * FROM USUARIOS WHERE idUSUARIOS = ?", [req.params.id]);
          case 5:
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            _context3.next = 5;
            return connection.query("INSERT INTO USUARIOS(EMAIL, E_PASSWORD, NAME, SURNAME, PHONE) VALUES (?,?,?,?,?)", [req.body.email, req.body.password, req.body.name, req.body.surname, req.body.phone]);
          case 5:
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            ...
            _context4.next = 5;
            return connection.query("UPDATE USUARIOS SET ? WHERE idUSUARIOS = ?", [req.body, req.params.id]);
          case 5:
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 2:
            ...
            _context5.next = 5;
            return connection.query("DELETE FROM USUARIOS WHERE idUSUARIOS = ?", [req.params.id]);
          case 5:
            res.sendStatus(204);
          case 6:
          case "end":
